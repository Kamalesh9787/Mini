...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Mini_Request')
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/AGr.jpg https://envs.sh/AGr.jpg')).split()
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://costly-lissie-autourl-3b4bd43f.koyeb.app/")
